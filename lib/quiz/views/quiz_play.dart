...
import 'package:korkort11/quiz/models/question_model.dart';
import 'package:korkort11/quiz/services/database.dart';
import 'package:korkort11/quiz/views/home.dart';
import 'package:korkort11/quiz/views/results.dart';
import 'package:korkort11/quiz/widget/widget.dart';
import 'package:korkort11/quiz/widgets/quiz_play_widgets.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("الأختبار",style: TextStyle(
            color: Colors.black,
            fontFamily: "cairo"
        ),),
